...
object TorrentHelper {
    ...
    fun getTorrentPlayPreloadLink(torr: Torrent, file: FileStat): String {
        return Net.getHostUrl("/stream/${torr.title.urlEncode()}?link=${torr.hash}&index=${file.id}&play&preload")
    }
}